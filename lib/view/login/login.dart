// ignore_for_file: unused_local_variable, unused_import, use_key_in_widget_constructors, prefer_const_constructors
...
import 'package:shop_app/custom_widgets/toastWidget.dart';
                        ...
                        child: CustomButton(
                          ...
                          function: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              customToast(
                                text: 'تم تسجيل الدخولبنجاح ي علي',
                                color: Colors.green,
                              );
                            } else {
                              customToast(
                                text: 'عفوا برجاء لتاكد من البيانات المدخله!',
                                color: Colors.red,
                              );
                            }
                          },
